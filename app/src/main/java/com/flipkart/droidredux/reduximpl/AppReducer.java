...
public class AppReducer extends FreezableReducer<AppState, AppAction> {

    public static final String DEFAULT_SCREEN = "DEFAULT";

    @Override
    protected AppState reduceThawed(@NonNull AppState frozenState, @NonNull AppState thawedState, @NonNull AppAction action) {
